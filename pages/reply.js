  ...
  try {
    await lock.acquire(discordID, async () => {
      ...
      if (parsedurl.query.message !== "") {
        ...
        processedmessage = "> Replying to \"" + "_" + reply_message_content + "_" + "\" from " + author_mention + ": [jump](https://discord.com/channels/"+channel.guild.id+"/"+channel.id+"/"+reply_message.id+")\n" + processedmessage;
